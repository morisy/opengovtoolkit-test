...
state: "Idaho"
abbreviation: "ID"
foia_law: "Idaho Public Records Act"
foia_citation: "Idaho Code §§ 74-101 to 74-126"
open_meetings_law: "Idaho Open Meeting Law"
open_meetings_citation: "Idaho Code §§ 74-201 to 74-208"
response_time: "3 business days (may extend 10 more)"
fee_structure: "Actual cost of copying; labor costs for extended searches"
...
**You have the right to request public records in Idaho.** Any person can submit a public records request to any public body in Idaho. You do not need to give a reason for your request.

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 3 business days (may extend 10 more)
- If denied, the response must cite a specific exemption
- You do not need to be a Idaho resident to make a request

**Sample request language you can copy:**

> Pursuant to the Idaho Public Records Act, Idaho Code §§ 74-101 to 74-126, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law. If any portion of this request is denied, please cite the specific exemption and release all reasonably segregable portions.

## Records Laws

Idaho's Idaho Public Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Idaho law include:
...
Under Idaho law:
- Actual cost of copying; labor costs for extended searches
...
Idaho's Idaho Open Meeting Law requires that government bodies conduct their business openly.
...
Violations of Idaho's open meetings law can result in:
...
### Practical tips for Idaho public records requests
...
- **Idaho Attorney General's Office** — may provide guidance on public records compliance
- **Idaho Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Idaho](https://www.rcfp.org/open-government-guide/idaho/)
