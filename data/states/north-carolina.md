...
abbreviation: "NC"
foia_law: "North Carolina Public Records Law"
foia_citation: "N.C. Gen. Stat. §§ 132-1 to 132-10"
open_meetings_law: "North Carolina Open Meetings Law"
open_meetings_citation: "N.C. Gen. Stat. §§ 143-318.9 to 143-318.18"
response_time: "Prompt (as promptly as possible; no specific deadline)"
fee_structure: "Actual cost of reproducing and copying; reasonable special service charges"
enforcement_body: "Superior Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in North Carolina.** Any person can submit a public records request to a public body in North Carolina. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check North Carolina's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within Prompt (as promptly as possible; no specific deadline)
...
> In accordance with the North Carolina Public Records Law, N.C. Gen. Stat. §§ 132-1 to 132-10, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under North Carolina law is Prompt (as promptly as possible; no specific deadline). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

North Carolina's North Carolina Public Records Law provides public access to government records held by state and local agencies.
...
Common exemptions under North Carolina law include:
...
- Actual cost of reproducing and copying; reasonable special service charges
...
North Carolina's North Carolina Open Meetings Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of North Carolina's open meetings law can result in:
...
### Practical tips for North Carolina public records requests
...
- **North Carolina Attorney General's Office** — may provide guidance on public records compliance
- **North Carolina Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for North Carolina](https://www.rcfp.org/open-government-guide/north-carolina/)
