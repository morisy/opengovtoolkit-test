...
abbreviation: "DC"
foia_law: "DC Freedom of Information Act"
foia_citation: "D.C. Code §§ 2-531 to 2-540"
open_meetings_law: "DC Open Meetings Act"
open_meetings_citation: "D.C. Code §§ 2-571 to 2-580"
response_time: "15 business days (may extend 10 more)"
fee_structure: "Actual cost of searching and copying; first 2 hours of search free"
enforcement_body: "DC Superior Court; Office of Open Government"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in District of Columbia.** Any person can submit a public records request to a public body in District of Columbia. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check District of Columbia's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 15 business days (may extend 10 more)
...
> In accordance with the DC Freedom of Information Act, D.C. Code §§ 2-531 to 2-540, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under District of Columbia law is 15 business days (may extend 10 more). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

District of Columbia's DC Freedom of Information Act provides public access to government records held by state and local agencies.
...
Common exemptions under District of Columbia law include:
...
- Actual cost of searching and copying; first 2 hours of search free
...
1. You may file an appeal to DC Superior Court — ask what the process is
2. You may file a lawsuit in Office of Open Government (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
District of Columbia's DC Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of District of Columbia's open meetings law can result in:
...
### Practical tips for District of Columbia public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to DC Superior Court

### Key contacts

- **District of Columbia Attorney General's Office** — may provide guidance on public records compliance
- **District of Columbia Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for District of Columbia](https://www.rcfp.org/open-government-guide/district-of-columbia/)
