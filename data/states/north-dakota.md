...
state: "North Dakota"
abbreviation: "ND"
foia_law: "North Dakota Open Records Law"
foia_citation: "N.D. Cent. Code §§ 44-04-18 to 44-04-18.27"
open_meetings_law: "North Dakota Open Meetings Law"
open_meetings_citation: "N.D. Cent. Code §§ 44-04-19 to 44-04-21"
response_time: "Reasonable time (one business day for determining if records are open)"
fee_structure: "Actual cost of copying; $0.25/page; reasonable hourly fee for time exceeding 1 hour"
enforcement_body: "Attorney General (opinions); District Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in North Dakota.** Any person can submit a public records request to a public body in North Dakota. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check North Dakota's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within a reasonable time — other states have firmer deadlines
...
> In accordance with the North Dakota Open Records Law, N.D. Cent. Code §§ 44-04-18 to 44-04-18.27, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under North Dakota law is a reasonable time. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

North Dakota's North Dakota Open Records Law provides public access to government records held by state and local agencies.
...
Common exemptions under North Dakota law include:
...
- Actual cost of copying; $0.25/page; reasonable hourly fee for time exceeding 1 hour
...
1. You may file an appeal to Attorney General (opinions) — ask what the process is
2. You may file a lawsuit in District Court (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
North Dakota's North Dakota Open Meetings Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of North Dakota's open meetings law can result in:
...
### Practical tips for North Dakota public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Attorney General (opinions)

### Key contacts

- **North Dakota Attorney General's Office** — may provide guidance on public records compliance
- **North Dakota Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for North Dakota](https://www.rcfp.org/open-government-guide/north-dakota/)
