...
state: "Mississippi"
abbreviation: "MS"
foia_law: "Mississippi Public Records Act"
foia_citation: "Miss. Code §§ 25-61-1 to 25-61-17"
open_meetings_law: "Mississippi Open Meetings Act"
open_meetings_citation: "Miss. Code §§ 25-41-1 to 25-41-17"
response_time: "7 business days (may extend 7 more)"
fee_structure: "Actual cost of reproduction"
enforcement_body: "Ethics Commission; Chancery Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Mississippi.** Any person can submit a public records request to a public body in Mississippi. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Mississippi's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 7 business days (may extend 7 more)
...
> In accordance with the Mississippi Public Records Act, Miss. Code §§ 25-61-1 to 25-61-17, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Mississippi law is 7 business days (may extend 7 more). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Mississippi's Mississippi Public Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Mississippi law include:
...
1. You may file an appeal to Ethics Commission — ask what the process is
2. You may file a lawsuit in Chancery Court (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
Mississippi's Mississippi Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Mississippi's open meetings law can result in:
...
### Practical tips for Mississippi public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Ethics Commission

### Key contacts

- **Mississippi Attorney General's Office** — may provide guidance on public records compliance
- **Mississippi Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Mississippi](https://www.rcfp.org/open-government-guide/mississippi/)
