...
state: "California"
abbreviation: "CA"
foia_law: "California Public Records Act (CPRA)"
foia_citation: "Cal. Gov. Code §§ 7920.000–7931.000"
open_meetings_law: "Ralph M. Brown Act"
open_meetings_citation: "Cal. Gov. Code §§ 54950–54963"
response_time: "10 calendar days (may extend 14 more)"
fee_structure: "Direct cost of duplication; electronic records at no cost if feasible"
...
**You have the right to request public records in California.** Any person can submit a public records request to a public body in California. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check California's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 10 calendar days (may extend 14 more)
...
> In accordance with the California Public Records Act (CPRA), Cal. Gov. Code §§ 7920.000–7931.000, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under California law is 10 calendar days (may extend 14 more). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

California's California Public Records Act (CPRA) provides public access to government records held by state and local agencies.
...
Common exemptions under California law include:
...
- Direct cost of duplication; electronic records at no cost if feasible
...
California's Ralph M. Brown Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of California's open meetings law can result in:
...
### Practical tips for California public records requests
...
- **California Attorney General's Office** — may provide guidance on public records compliance
- **California Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for California](https://www.rcfp.org/open-government-guide/california/)
