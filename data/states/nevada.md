...
state: "Nevada"
abbreviation: "NV"
foia_law: "Nevada Public Records Act"
foia_citation: "Nev. Rev. Stat. §§ 239.005–239.030"
open_meetings_law: "Nevada Open Meeting Law"
open_meetings_citation: "Nev. Rev. Stat. §§ 241.010–241.040"
response_time: "5 business days (may extend in extraordinary circumstances)"
fee_structure: "Actual cost of providing a copy; no fee if records available electronically"
...
**You have the right to request public records in Nevada.** Any person can submit a public records request to a public body in Nevada. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Nevada's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 5 business days (may extend in extraordinary circumstances)
...
> In accordance with the Nevada Public Records Act, Nev. Rev. Stat. §§ 239.005–239.030, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Nevada law is 5 business days (may extend in extraordinary circumstances). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Nevada's Nevada Public Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Nevada law include:
...
Under Nevada law:
- Actual cost of providing a copy; no fee if records available electronically
...
Nevada's Nevada Open Meeting Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Nevada's open meetings law can result in:
...
### Practical tips for Nevada public records requests
...
- **Nevada Attorney General's Office** — may provide guidance on public records compliance
- **Nevada Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Nevada](https://www.rcfp.org/open-government-guide/nevada/)
