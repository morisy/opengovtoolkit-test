...
state: "Wisconsin"
abbreviation: "WI"
foia_law: "Wisconsin Open Records Law"
foia_citation: "Wis. Stat. §§ 19.31–19.39"
open_meetings_law: "Wisconsin Open Meetings Law"
open_meetings_citation: "Wis. Stat. §§ 19.81–19.98"
response_time: "10 business days (as soon as practicable without delay)"
fee_structure: "Actual, necessary, and direct cost of reproduction; location fee limited"
enforcement_body: "Circuit Court; District Attorney"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Wisconsin.** Any person can submit a public records request to a public body in Wisconsin. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Wisconsin's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 10 business days (as soon as practicable without delay)
...
> In accordance with the Wisconsin Open Records Law, Wis. Stat. §§ 19.31–19.39, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Wisconsin law is 10 business days (as soon as practicable without delay). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Wisconsin's Wisconsin Open Records Law provides public access to government records held by state and local agencies.
...
Common exemptions under Wisconsin law include:
...
Under Wisconsin law:
- Actual, necessary, and direct cost of reproduction; location fee limited
...
2. You may file a lawsuit in District Attorney (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
Wisconsin's Wisconsin Open Meetings Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Wisconsin's open meetings law can result in:
...
### Practical tips for Wisconsin public records requests
...
- **Wisconsin Attorney General's Office** — may provide guidance on public records compliance
- **Wisconsin Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Wisconsin](https://www.rcfp.org/open-government-guide/wisconsin/)
