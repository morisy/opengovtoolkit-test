...
state: "Hawaii"
abbreviation: "HI"
foia_law: "Uniform Information Practices Act (UIPA)"
foia_citation: "Haw. Rev. Stat. §§ 92F-1 to 92F-42"
open_meetings_law: "Hawaii Sunshine Law"
open_meetings_citation: "Haw. Rev. Stat. §§ 92-1 to 92-13"
response_time: "10 business days (may extend 20 more in exceptional cases)"
fee_structure: "Actual cost of searching, reviewing, and copying"
enforcement_body: "Office of Information Practices; Circuit Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Hawaii.** Any person can submit a public records request to a public body in Hawaii. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Hawaii's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 10 business days (may extend 20 more in exceptional cases)
...
> In accordance with the Uniform Information Practices Act (UIPA), Haw. Rev. Stat. §§ 92F-1 to 92F-42, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Hawaii law is 10 business days (may extend 20 more in exceptional cases). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Hawaii's Uniform Information Practices Act (UIPA) provides public access to government records held by state and local agencies.
...
Common exemptions under Hawaii law include:
...
Under Hawaii law:
- Actual cost of searching, reviewing, and copying
...
1. You may file an appeal to Office of Information Practices — ask what the process is
...
Hawaii's Hawaii Sunshine Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Hawaii's open meetings law can result in:
...
### Practical tips for Hawaii public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Office of Information Practices

### Key contacts

- **Hawaii Attorney General's Office** — may provide guidance on public records compliance
- **Hawaii Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Hawaii](https://www.rcfp.org/open-government-guide/hawaii/)
