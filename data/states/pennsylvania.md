...
state: "Pennsylvania"
abbreviation: "PA"
foia_law: "Pennsylvania Right-to-Know Law"
foia_citation: "65 Pa. Stat. §§ 67.101–67.3104"
open_meetings_law: "Pennsylvania Sunshine Act"
open_meetings_citation: "65 Pa. Stat. §§ 701–716"
response_time: "5 business days (may extend 30 more)"
fee_structure: "Actual cost of duplication; $0.25/page for paper copies"
enforcement_body: "Office of Open Records; Commonwealth Court; Court of Common Pleas"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Pennsylvania.** Any person can submit a public records request to a public body in Pennsylvania. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Pennsylvania's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 5 business days (may extend 30 more)
...
> In accordance with the Pennsylvania Right-to-Know Law, 65 Pa. Stat. §§ 67.101–67.3104, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Pennsylvania law is 5 business days (may extend 30 more). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Pennsylvania's Pennsylvania Right-to-Know Law provides public access to government records held by state and local agencies.
...
Common exemptions under Pennsylvania law include:
...
- Actual cost of duplication; $0.25/page for paper copies
...
1. You may file an appeal to Office of Open Records — ask what the process is
2. You may file a lawsuit in Court of Common Pleas (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
Pennsylvania's Pennsylvania Sunshine Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Pennsylvania's open meetings law can result in:
...
### Practical tips for Pennsylvania public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Office of Open Records

### Key contacts

- **Pennsylvania Attorney General's Office** — may provide guidance on public records compliance
- **Pennsylvania Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Pennsylvania](https://www.rcfp.org/open-government-guide/pennsylvania/)
