...
state: "Rhode Island"
abbreviation: "RI"
foia_law: "Rhode Island Access to Public Records Act (APRA)"
foia_citation: "R.I. Gen. Laws §§ 38-2-1 to 38-2-15"
open_meetings_law: "Rhode Island Open Meetings Act"
open_meetings_citation: "R.I. Gen. Laws §§ 42-46-1 to 42-46-14"
response_time: "10 business days (may extend 20 more)"
fee_structure: "Actual cost of copying; $0.15/page"
enforcement_body: "Attorney General; Superior Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Rhode Island.** Any person can submit a public records request to a public body in Rhode Island. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Rhode Island's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 10 business days (may extend 20 more)
...
> In accordance with the Rhode Island Access to Public Records Act (APRA), R.I. Gen. Laws §§ 38-2-1 to 38-2-15, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Rhode Island law is 10 business days (may extend 20 more). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Rhode Island's Rhode Island Access to Public Records Act (APRA) provides public access to government records held by state and local agencies.
...
Common exemptions under Rhode Island law include:
...
- Actual cost of copying; $0.15/page
...
Rhode Island's Rhode Island Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Rhode Island's open meetings law can result in:
...
### Practical tips for Rhode Island public records requests
...
- **Rhode Island Attorney General's Office** — may provide guidance on public records compliance
- **Rhode Island Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Rhode Island](https://www.rcfp.org/open-government-guide/rhode-island/)
