...
state: "Georgia"
abbreviation: "GA"
foia_law: "Georgia Open Records Act"
foia_citation: "O.C.G.A. §§ 50-18-70 to 50-18-77"
open_meetings_law: "Georgia Open Meetings Act"
open_meetings_citation: "O.C.G.A. §§ 50-14-1 to 50-14-6"
response_time: "3 business days"
fee_structure: "Actual cost of reproduction; $0.10/page for letter-size copies"
...
**You have the right to request public records in Georgia.** Any person can submit a public records request to a public body in Georgia. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Georgia's rules before relying on this.*
...
> In accordance with the Georgia Open Records Act, O.C.G.A. §§ 50-18-70 to 50-18-77, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Georgia law is 3 business days. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Georgia's Georgia Open Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Georgia law include:
...
Under Georgia law:
- Actual cost of reproduction; $0.10/page for letter-size copies
...
Georgia's Georgia Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Georgia's open meetings law can result in:
...
### Practical tips for Georgia public records requests
...
- **Georgia Attorney General's Office** — may provide guidance on public records compliance
- **Georgia Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Georgia](https://www.rcfp.org/open-government-guide/georgia/)
