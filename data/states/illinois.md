...
state: "Illinois"
abbreviation: "IL"
foia_law: "Illinois Freedom of Information Act"
foia_citation: "5 ILCS 140/1 et seq."
open_meetings_law: "Illinois Open Meetings Act"
open_meetings_citation: "5 ILCS 120/1 et seq."
response_time: "5 business days (may extend 5 more)"
fee_structure: "First 50 pages black-and-white free; $0.15/page after"
...
**You have the right to request public records in Illinois.** Any person can submit a public records request to a public body in Illinois. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Illinois's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 5 business days (may extend 5 more)
...
> In accordance with the Illinois Freedom of Information Act, 5 ILCS 140/1 et seq., I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Illinois law is 5 business days (may extend 5 more). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Illinois's Illinois Freedom of Information Act provides public access to government records held by state and local agencies.
...
Common exemptions under Illinois law include:
...
Under Illinois law:
- First 50 pages black-and-white free; $0.15/page after
...
Illinois's Illinois Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Illinois's open meetings law can result in:
...
### Practical tips for Illinois public records requests
...
- **Illinois Attorney General's Office** — may provide guidance on public records compliance
- **Illinois Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Illinois](https://www.rcfp.org/open-government-guide/illinois/)
