...
state: "Wyoming"
abbreviation: "WY"
foia_law: "Wyoming Public Records Act"
foia_citation: "Wyo. Stat. §§ 16-4-201 to 16-4-205"
open_meetings_law: "Wyoming Public Meetings Act"
open_meetings_citation: "Wyo. Stat. §§ 16-4-401 to 16-4-408"
response_time: "Reasonable time (no specific statutory deadline)"
fee_structure: "Actual cost of providing a copy"
...
**You have the right to request public records in Wyoming.** Any person can submit a public records request to a public body in Wyoming. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Wyoming's rules before relying on this.*
...
> In accordance with the Wyoming Public Records Act, Wyo. Stat. §§ 16-4-201 to 16-4-205, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Wyoming law is a reasonable time. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Wyoming's Wyoming Public Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Wyoming law include:
...
Under Wyoming law:
- Actual cost of providing a copy
...
Wyoming's Wyoming Public Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Wyoming's open meetings law can result in:
...
### Practical tips for Wyoming public records requests
...
- **Wyoming Attorney General's Office** — may provide guidance on public records compliance
- **Wyoming Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Wyoming](https://www.rcfp.org/open-government-guide/wyoming/)
