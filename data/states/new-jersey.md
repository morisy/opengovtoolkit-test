...
state: "New Jersey"
abbreviation: "NJ"
foia_law: "Open Public Records Act (OPRA)"
foia_citation: "N.J. Stat. §§ 47:1A-1 to 47:1A-13"
open_meetings_law: "Open Public Meetings Act"
open_meetings_citation: "N.J. Stat. §§ 10:4-6 to 10:4-21"
response_time: "7 business days (may extend with written notice)"
fee_structure: "Actual cost of duplication; $0.05/letter-size page; $0.07/legal-size page"
enforcement_body: "Government Records Council; Superior Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in New Jersey.** Any person can submit a public records request to a public body in New Jersey. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check New Jersey's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 7 business days (may extend with written notice)
...
> In accordance with the Open Public Records Act (OPRA), N.J. Stat. §§ 47:1A-1 to 47:1A-13, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under New Jersey law is 7 business days (may extend with written notice). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

New Jersey's Open Public Records Act (OPRA) provides public access to government records held by state and local agencies.
...
Common exemptions under New Jersey law include:
...
- Actual cost of duplication; $0.05/letter-size page; $0.07/legal-size page
...
1. You may file an appeal to Government Records Council — ask what the process is
...
New Jersey's Open Public Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of New Jersey's open meetings law can result in:
...
### Practical tips for New Jersey public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Government Records Council

### Key contacts

- **New Jersey Attorney General's Office** — may provide guidance on public records compliance
- **New Jersey Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for New Jersey](https://www.rcfp.org/open-government-guide/new-jersey/)
