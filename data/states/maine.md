...
state: "Maine"
abbreviation: "ME"
foia_law: "Maine Freedom of Access Act"
foia_citation: "Me. Rev. Stat. tit. 1, §§ 400–414"
open_meetings_law: "Maine Freedom of Access Act (meetings)"
open_meetings_citation: "Me. Rev. Stat. tit. 1, §§ 400–414"
response_time: "5 business days (reasonable delay permitted)"
fee_structure: "Actual cost of copying; may charge for staff time over 2 hours"
enforcement_body: "Superior Court; Public Access Ombudsman"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Maine.** Any person can submit a public records request to a public body in Maine. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Maine's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 5 business days (reasonable delay permitted)
...
> In accordance with the Maine Freedom of Access Act, Me. Rev. Stat. tit. 1, §§ 400–414, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Maine law is 5 business days (reasonable delay permitted). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Maine's Maine Freedom of Access Act provides public access to government records held by state and local agencies.
...
Common exemptions under Maine law include:
...
Under Maine law:
- Actual cost of copying; may charge for staff time over 2 hours
...
2. You may file a lawsuit in Public Access Ombudsman (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
Maine's Maine Freedom of Access Act (meetings) requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Maine's open meetings law can result in:
...
### Practical tips for Maine public records requests
...
- **Maine Attorney General's Office** — may provide guidance on public records compliance
- **Maine Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Maine](https://www.rcfp.org/open-government-guide/maine/)
