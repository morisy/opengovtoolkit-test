...
state: "Texas"
abbreviation: "TX"
foia_law: "Texas Public Information Act (TPIA)"
foia_citation: "Tex. Gov. Code §§ 552.001–552.353"
open_meetings_law: "Texas Open Meetings Act"
open_meetings_citation: "Tex. Gov. Code §§ 551.001–551.146"
response_time: "10 business days (must request AG ruling within that period if withholding)"
fee_structure: "Actual cost of reproduction; labor charges for programming/manipulation; $0.10/page"
enforcement_body: "Attorney General (rulings); District Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Texas.** Any person can submit a public records request to a public body in Texas. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Texas's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 10 business days (must request AG ruling within that period if withholding)
...
> In accordance with the Texas Public Information Act (TPIA), Tex. Gov. Code §§ 552.001–552.353, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Texas law is 10 business days (must request AG ruling within that period if withholding). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Texas's Texas Public Information Act (TPIA) provides public access to government records held by state and local agencies.
...
Common exemptions under Texas law include:
...
Under Texas law:
- Actual cost of reproduction; labor charges for programming/manipulation; $0.10/page
...
1. You may file an appeal to Attorney General (rulings) — ask what the process is
...
Texas's Texas Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Texas's open meetings law can result in:
...
### Practical tips for Texas public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Attorney General (rulings)

### Key contacts

- **Texas Attorney General's Office** — may provide guidance on public records compliance
- **Texas Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Texas](https://www.rcfp.org/open-government-guide/texas/)
