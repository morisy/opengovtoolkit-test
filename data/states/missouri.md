...
state: "Missouri"
abbreviation: "MO"
foia_law: "Missouri Sunshine Law"
foia_citation: "Mo. Rev. Stat. §§ 610.010–610.035"
open_meetings_law: "Missouri Sunshine Law (meetings)"
open_meetings_citation: "Mo. Rev. Stat. §§ 610.010–610.035"
response_time: "3 business days (may extend to end of third business day after receipt)"
fee_structure: "Actual cost of document search, duplication, and staff time; $0.10/page"
enforcement_body: "Circuit Court; Attorney General"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Missouri.** Any person can submit a public records request to a public body in Missouri. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Missouri's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 3 business days (may extend to end of third business day after receipt)
...
> In accordance with the Missouri Sunshine Law, Mo. Rev. Stat. §§ 610.010–610.035, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Missouri law is 3 business days (may extend to end of third business day after receipt). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Missouri's Missouri Sunshine Law provides public access to government records held by state and local agencies.
...
Common exemptions under Missouri law include:
...
Under Missouri law:
- Actual cost of document search, duplication, and staff time; $0.10/page
...
1. You may file an appeal to Circuit Court — ask what the process is
...
Missouri's Missouri Sunshine Law (meetings) requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Missouri's open meetings law can result in:
...
### Practical tips for Missouri public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Circuit Court

### Key contacts

- **Missouri Attorney General's Office** — may provide guidance on public records compliance
- **Missouri Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Missouri](https://www.rcfp.org/open-government-guide/missouri/)
