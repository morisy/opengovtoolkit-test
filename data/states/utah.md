...
state: "Utah"
abbreviation: "UT"
foia_law: "Government Records Access and Management Act (GRAMA)"
foia_citation: "Utah Code §§ 63G-2-101 to 63G-2-901"
open_meetings_law: "Utah Open and Public Meetings Act"
open_meetings_citation: "Utah Code §§ 52-4-101 to 52-4-305"
response_time: "10 business days (may extend with written explanation)"
fee_structure: "Actual cost of providing a copy; reasonable hourly rate for compilation"
enforcement_body: "State Records Committee; District Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Utah.** Any person can submit a public records request to a public body in Utah. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Utah's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 10 business days (may extend with written explanation)
...
> In accordance with the Government Records Access and Management Act (GRAMA), Utah Code §§ 63G-2-101 to 63G-2-901, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Utah law is 10 business days (may extend with written explanation). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Utah's Government Records Access and Management Act (GRAMA) provides public access to government records held by state and local agencies.
...
Common exemptions under Utah law include:
...
Under Utah law:
- Actual cost of providing a copy; reasonable hourly rate for compilation
...
1. You may file an appeal to State Records Committee — ask what the process is
...
Utah's Utah Open and Public Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Utah's open meetings law can result in:
...
### Practical tips for Utah public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to State Records Committee

### Key contacts

- **Utah Attorney General's Office** — may provide guidance on public records compliance
- **Utah Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Utah](https://www.rcfp.org/open-government-guide/utah/)
