...
state: "Vermont"
abbreviation: "VT"
foia_law: "Vermont Public Records Act"
foia_citation: "Vt. Stat. tit. 1, §§ 315–320"
open_meetings_law: "Vermont Open Meeting Law"
open_meetings_citation: "Vt. Stat. tit. 1, §§ 310–314"
response_time: "3 business days (may extend 10 more with notice)"
fee_structure: "Actual cost of providing a copy; reasonable labor costs"
enforcement_body: "Superior Court; Secretary of State"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Vermont.** Any person can submit a public records request to a public body in Vermont. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Vermont's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 3 business days (may extend 10 more with notice)
...
> In accordance with the Vermont Public Records Act, Vt. Stat. tit. 1, §§ 315–320, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Vermont law is 3 business days (may extend 10 more with notice). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Vermont's Vermont Public Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Vermont law include:
...
Under Vermont law:
- Actual cost of providing a copy; reasonable labor costs
...
1. You may file an appeal to Superior Court — ask what the process is
2. You may file a lawsuit in Secretary of State (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
Vermont's Vermont Open Meeting Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Vermont's open meetings law can result in:
...
### Practical tips for Vermont public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Superior Court

### Key contacts

- **Vermont Attorney General's Office** — may provide guidance on public records compliance
- **Vermont Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Vermont](https://www.rcfp.org/open-government-guide/vermont/)
