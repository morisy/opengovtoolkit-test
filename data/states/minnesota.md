...
state: "Minnesota"
abbreviation: "MN"
foia_law: "Minnesota Government Data Practices Act (MGDPA)"
foia_citation: "Minn. Stat. §§ 13.01–13.99"
open_meetings_law: "Minnesota Open Meeting Law"
open_meetings_citation: "Minn. Stat. § 13D"
response_time: "Immediate (if data is public and readily available); otherwise reasonable time"
fee_structure: "Actual cost of copying; $0.25/page"
enforcement_body: "Office of Administrative Hearings; District Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Minnesota.** Any person can submit a public records request to a public body in Minnesota. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Minnesota's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within Immediate (if data is public and readily available); otherwise reasonable time
...
> In accordance with the Minnesota Government Data Practices Act (MGDPA), Minn. Stat. §§ 13.01–13.99, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Minnesota law is Immediate (if data is public and readily available); otherwise reasonable time. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Minnesota's Minnesota Government Data Practices Act (MGDPA) provides public access to government records held by state and local agencies.
...
Common exemptions under Minnesota law include:
...
Under Minnesota law:
- Actual cost of copying; $0.25/page
...
1. You may file an appeal to Office of Administrative Hearings — ask what the process is
...
Minnesota's Minnesota Open Meeting Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Minnesota's open meetings law can result in:
...
### Practical tips for Minnesota public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Office of Administrative Hearings

### Key contacts

- **Minnesota Attorney General's Office** — may provide guidance on public records compliance
- **Minnesota Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Minnesota](https://www.rcfp.org/open-government-guide/minnesota/)
