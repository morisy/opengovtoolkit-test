...
state: "Florida"
abbreviation: "FL"
foia_law: "Florida Public Records Act"
foia_citation: "Fla. Stat. § 119"
open_meetings_law: "Florida Sunshine Law"
open_meetings_citation: "Fla. Stat. § 286.011"
response_time: "Prompt (no specific statutory deadline)"
fee_structure: "Actual cost of duplication; $0.15/page for one-sided copies"
...
**You have the right to request public records in Florida.** Any person can submit a public records request to a public body in Florida. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Florida's rules before relying on this.*
...
> In accordance with the Florida Public Records Act, Fla. Stat. § 119, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Florida law is a reasonable time. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Florida's Florida Public Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Florida law include:
...
Under Florida law:
- Actual cost of duplication; $0.15/page for one-sided copies
...
Florida's Florida Sunshine Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Florida's open meetings law can result in:
...
### Practical tips for Florida public records requests
...
- **Florida Attorney General's Office** — may provide guidance on public records compliance
- **Florida Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Florida](https://www.rcfp.org/open-government-guide/florida/)
