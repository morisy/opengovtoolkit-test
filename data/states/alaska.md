...
state: "Alaska"
abbreviation: "AK"
foia_law: "Alaska Public Records Act"
foia_citation: "Alaska Stat. §§ 40.25.100–40.25.220"
open_meetings_law: "Alaska Open Meetings Act"
open_meetings_citation: "Alaska Stat. §§ 44.62.310–44.62.312"
response_time: "10 business days"
fee_structure: "Actual cost of copying; no search fees for first 5 pages"
...
**You have the right to request public records in Alaska.** Any person can submit a public records request to a public body in Alaska. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Alaska's rules before relying on this.*
...
> In accordance with the Alaska Public Records Act, Alaska Stat. §§ 40.25.100–40.25.220, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Alaska law is 10 business days. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Alaska's Alaska Public Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Alaska law include:
...
Under Alaska law:
- Actual cost of copying; no search fees for first 5 pages
...
Alaska's Alaska Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Alaska's open meetings law can result in:
...
### Practical tips for Alaska public records requests
...
- **Alaska Attorney General's Office** — may provide guidance on public records compliance
- **Alaska Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Alaska](https://www.rcfp.org/open-government-guide/alaska/)
