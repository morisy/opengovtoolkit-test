...
state: "Nebraska"
abbreviation: "NE"
foia_law: "Nebraska Public Records Statutes"
foia_citation: "Neb. Rev. Stat. §§ 84-712 to 84-712.09"
open_meetings_law: "Nebraska Open Meetings Act"
open_meetings_citation: "Neb. Rev. Stat. §§ 84-1407 to 84-1414"
response_time: "4 business days (may extend with written explanation)"
fee_structure: "Actual cost of reproduction; reasonable special service charge"
...
**You have the right to request public records in Nebraska.** Any person can submit a public records request to a public body in Nebraska. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Nebraska's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 4 business days (may extend with written explanation)
...
> In accordance with the Nebraska Public Records Statutes, Neb. Rev. Stat. §§ 84-712 to 84-712.09, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Nebraska law is 4 business days (may extend with written explanation). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Nebraska's Nebraska Public Records Statutes provides public access to government records held by state and local agencies.
...
Common exemptions under Nebraska law include:
...
Under Nebraska law:
- Actual cost of reproduction; reasonable special service charge
...
Nebraska's Nebraska Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Nebraska's open meetings law can result in:
...
### Practical tips for Nebraska public records requests
...
- **Nebraska Attorney General's Office** — may provide guidance on public records compliance
- **Nebraska Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Nebraska](https://www.rcfp.org/open-government-guide/nebraska/)
