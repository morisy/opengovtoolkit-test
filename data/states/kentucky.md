...
state: "Kentucky"
abbreviation: "KY"
foia_law: "Kentucky Open Records Act"
foia_citation: "Ky. Rev. Stat. §§ 61.870–61.884"
open_meetings_law: "Kentucky Open Meetings Act"
open_meetings_citation: "Ky. Rev. Stat. §§ 61.800–61.850"
response_time: "5 business days (may extend for cause)"
fee_structure: "Actual cost of non-personal copies; $0.10/page"
enforcement_body: "Attorney General (binding opinions); Circuit Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Kentucky.** Any person can submit a public records request to a public body in Kentucky. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Kentucky's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 5 business days (may extend for cause)
...
> In accordance with the Kentucky Open Records Act, Ky. Rev. Stat. §§ 61.870–61.884, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Kentucky law is 5 business days (may extend for cause). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Kentucky's Kentucky Open Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Kentucky law include:
...
Under Kentucky law:
- Actual cost of non-personal copies; $0.10/page
...
1. You may file an appeal to Attorney General (binding opinions) — ask what the process is
...
Kentucky's Kentucky Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Kentucky's open meetings law can result in:
...
### Practical tips for Kentucky public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Attorney General (binding opinions)

### Key contacts

- **Kentucky Attorney General's Office** — may provide guidance on public records compliance
- **Kentucky Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Kentucky](https://www.rcfp.org/open-government-guide/kentucky/)
