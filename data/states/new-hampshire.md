...
state: "New Hampshire"
abbreviation: "NH"
foia_law: "New Hampshire Right-to-Know Law"
foia_citation: "N.H. Rev. Stat. §§ 91-A:1 to 91-A:10"
open_meetings_law: "New Hampshire Right-to-Know Law (meetings)"
open_meetings_citation: "N.H. Rev. Stat. §§ 91-A:1 to 91-A:10"
response_time: "5 business days"
fee_structure: "Actual cost of providing a copy; $0.25/page for paper copies"
enforcement_body: "Superior Court; Ombudsman"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in New Hampshire.** Any person can submit a public records request to a public body in New Hampshire. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check New Hampshire's rules before relying on this.*
...
> In accordance with the New Hampshire Right-to-Know Law, N.H. Rev. Stat. §§ 91-A:1 to 91-A:10, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under New Hampshire law is 5 business days. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

New Hampshire's New Hampshire Right-to-Know Law provides public access to government records held by state and local agencies.
...
Common exemptions under New Hampshire law include:
...
- Actual cost of providing a copy; $0.25/page for paper copies
...
2. You may file a lawsuit in Ombudsman (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
New Hampshire's New Hampshire Right-to-Know Law (meetings) requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of New Hampshire's open meetings law can result in:
...
### Practical tips for New Hampshire public records requests
...
- **New Hampshire Attorney General's Office** — may provide guidance on public records compliance
- **New Hampshire Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for New Hampshire](https://www.rcfp.org/open-government-guide/new-hampshire/)
