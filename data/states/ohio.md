...
state: "Ohio"
abbreviation: "OH"
foia_law: "Ohio Public Records Act"
foia_citation: "Ohio Rev. Code § 149.43"
open_meetings_law: "Ohio Open Meetings Act (Sunshine Law)"
open_meetings_citation: "Ohio Rev. Code § 121.22"
response_time: "Reasonable time (prompt preparation)"
fee_structure: "Actual cost of copying; no search fees; $0.05/page suggested"
enforcement_body: "Court of Claims; Mandamus in any court; Attorney General"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Ohio.** Any person can submit a public records request to a public body in Ohio. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Ohio's rules before relying on this.*
...
> In accordance with the Ohio Public Records Act, Ohio Rev. Code § 149.43, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Ohio law is a reasonable time. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Ohio's Ohio Public Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Ohio law include:
...
Under Ohio law:
- Actual cost of copying; no search fees; $0.05/page suggested
...
1. You may file an appeal to Court of Claims — ask what the process is
...
Ohio's Ohio Open Meetings Act (Sunshine Law) requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Ohio's open meetings law can result in:
...
### Practical tips for Ohio public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Court of Claims

### Key contacts

- **Ohio Attorney General's Office** — may provide guidance on public records compliance
- **Ohio Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Ohio](https://www.rcfp.org/open-government-guide/ohio/)
