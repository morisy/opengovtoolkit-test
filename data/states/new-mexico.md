...
state: "New Mexico"
abbreviation: "NM"
foia_law: "New Mexico Inspection of Public Records Act (IPRA)"
foia_citation: "N.M. Stat. §§ 14-2-1 to 14-2-12"
open_meetings_law: "New Mexico Open Meetings Act"
open_meetings_citation: "N.M. Stat. §§ 10-15-1 to 10-15-4"
response_time: "15 calendar days (may extend with written explanation)"
fee_structure: "Actual cost of copying; $1.00/page if actual cost not available"
enforcement_body: "District Court; Attorney General"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in New Mexico.** Any person can submit a public records request to a public body in New Mexico. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check New Mexico's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 15 calendar days (may extend with written explanation)
...
> In accordance with the New Mexico Inspection of Public Records Act (IPRA), N.M. Stat. §§ 14-2-1 to 14-2-12, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under New Mexico law is 15 calendar days (may extend with written explanation). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

New Mexico's New Mexico Inspection of Public Records Act (IPRA) provides public access to government records held by state and local agencies.
...
Common exemptions under New Mexico law include:
...
- Actual cost of copying; $1.00/page if actual cost not available
...
1. You may file an appeal to District Court — ask what the process is
2. You may file a lawsuit in Attorney General (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
New Mexico's New Mexico Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of New Mexico's open meetings law can result in:
...
### Practical tips for New Mexico public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to District Court

### Key contacts

- **New Mexico Attorney General's Office** — may provide guidance on public records compliance
- **New Mexico Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for New Mexico](https://www.rcfp.org/open-government-guide/new-mexico/)
