...
state: "Louisiana"
abbreviation: "LA"
foia_law: "Louisiana Public Records Act"
foia_citation: "La. Rev. Stat. §§ 44:1–44:41"
open_meetings_law: "Louisiana Open Meetings Law"
open_meetings_citation: "La. Rev. Stat. §§ 42:11–42:28"
response_time: "3 business days (may extend for cause)"
fee_structure: "Actual cost of reproduction; no search fees"
...
**You have the right to request public records in Louisiana.** Any person can submit a public records request to a public body in Louisiana. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Louisiana's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 3 business days (may extend for cause)
...
> In accordance with the Louisiana Public Records Act, La. Rev. Stat. §§ 44:1–44:41, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Louisiana law is 3 business days (may extend for cause). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Louisiana's Louisiana Public Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Louisiana law include:
...
Under Louisiana law:
- Actual cost of reproduction; no search fees
...
Louisiana's Louisiana Open Meetings Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Louisiana's open meetings law can result in:
...
### Practical tips for Louisiana public records requests
...
- **Louisiana Attorney General's Office** — may provide guidance on public records compliance
- **Louisiana Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Louisiana](https://www.rcfp.org/open-government-guide/louisiana/)
