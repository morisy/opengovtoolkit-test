...
state: "Delaware"
abbreviation: "DE"
foia_law: "Delaware Freedom of Information Act"
foia_citation: "Del. Code tit. 29, §§ 10001–10007"
open_meetings_law: "Delaware Freedom of Information Act (meetings)"
open_meetings_citation: "Del. Code tit. 29, §§ 10001–10007"
response_time: "15 business days"
fee_structure: "Reasonable fee for copying and administrative costs"
enforcement_body: "Attorney General; Court of Chancery"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Delaware.** Any person can submit a public records request to a public body in Delaware. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Delaware's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 15 business days
...
> In accordance with the Delaware Freedom of Information Act, Del. Code tit. 29, §§ 10001–10007, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Delaware law is 15 business days. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Delaware's Delaware Freedom of Information Act provides public access to government records held by state and local agencies.
...
Common exemptions under Delaware law include:
...
Under Delaware law:
- Reasonable fee for copying and administrative costs
...
1. You may file an appeal to Attorney General — ask what the process is
2. You may file a lawsuit in Court of Chancery (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
Delaware's Delaware Freedom of Information Act (meetings) requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Delaware's open meetings law can result in:
...
### Practical tips for Delaware public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Attorney General

### Key contacts

- **Delaware Attorney General's Office** — may provide guidance on public records compliance
- **Delaware Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Delaware](https://www.rcfp.org/open-government-guide/delaware/)
