...
state: "Alabama"
abbreviation: "AL"
foia_law: "Alabama Open Records Act"
foia_citation: "Ala. Code §§ 36-12-40 to 36-12-41"
open_meetings_law: "Alabama Open Meetings Act"
open_meetings_citation: "Ala. Code §§ 36-25A-1 to 36-25A-11"
response_time: "Reasonable time (no statutory deadline)"
fee_structure: "Actual cost of reproduction; search fees vary by agency"
...
**You have the right to request public records in Alabama.** Any person can submit a public records request to a public body in Alabama. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Alabama's rules before relying on this.*
...
> In accordance with the Alabama Open Records Act, Ala. Code §§ 36-12-40 to 36-12-41, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Alabama law is a reasonable time. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Alabama's Alabama Open Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Alabama law include:
...
Under Alabama law:
- Actual cost of reproduction; search fees vary by agency
...
Alabama's Alabama Open Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Alabama's open meetings law can result in:
...
### Practical tips for Alabama public records requests
...
- **Alabama Attorney General's Office** — may provide guidance on public records compliance
- **Alabama Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Alabama](https://www.rcfp.org/open-government-guide/alabama/)
