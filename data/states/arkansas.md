...
state: "Arkansas"
abbreviation: "AR"
foia_law: "Arkansas Freedom of Information Act"
foia_citation: "Ark. Code §§ 25-19-101 to 25-19-110"
open_meetings_law: "Arkansas Freedom of Information Act (meetings)"
open_meetings_citation: "Ark. Code § 25-19-106"
...
**You have the right to request public records in Arkansas.** Any person can submit a public records request to a public body in Arkansas. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Arkansas's rules before relying on this.*
...
> In accordance with the Arkansas Freedom of Information Act, Ark. Code §§ 25-19-101 to 25-19-110, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Arkansas law is 3 business days. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Arkansas's Arkansas Freedom of Information Act provides public access to government records held by state and local agencies.
...
Common exemptions under Arkansas law include:
...
Arkansas's Arkansas Freedom of Information Act (meetings) requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Arkansas's open meetings law can result in:
...
### Practical tips for Arkansas public records requests
...
- **Arkansas Attorney General's Office** — may provide guidance on public records compliance
- **Arkansas Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Arkansas](https://www.rcfp.org/open-government-guide/arkansas/)
