...
state: "Kansas"
abbreviation: "KS"
foia_law: "Kansas Open Records Act (KORA)"
foia_citation: "Kan. Stat. §§ 45-215 to 45-223"
open_meetings_law: "Kansas Open Meetings Act (KOMA)"
open_meetings_citation: "Kan. Stat. §§ 75-4317 to 75-4320a"
response_time: "3 business days (may request clarification adding 2 more)"
fee_structure: "Actual cost of providing access; fees must be uniform"
...
**You have the right to request public records in Kansas.** Any person can submit a public records request to a public body in Kansas. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Kansas's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 3 business days (may request clarification adding 2 more)
...
> In accordance with the Kansas Open Records Act (KORA), Kan. Stat. §§ 45-215 to 45-223, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Kansas law is 3 business days (may request clarification adding 2 more). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Kansas's Kansas Open Records Act (KORA) provides public access to government records held by state and local agencies.
...
Common exemptions under Kansas law include:
...
Under Kansas law:
- Actual cost of providing access; fees must be uniform
...
Kansas's Kansas Open Meetings Act (KOMA) requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Kansas's open meetings law can result in:
...
### Practical tips for Kansas public records requests
...
- **Kansas Attorney General's Office** — may provide guidance on public records compliance
- **Kansas Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Kansas](https://www.rcfp.org/open-government-guide/kansas/)
