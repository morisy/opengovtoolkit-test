...
state: "Connecticut"
abbreviation: "CT"
foia_law: "Connecticut Freedom of Information Act"
foia_citation: "Conn. Gen. Stat. §§ 1-200 to 1-242"
open_meetings_law: "Connecticut Freedom of Information Act (meetings)"
open_meetings_citation: "Conn. Gen. Stat. §§ 1-225 to 1-232"
response_time: "4 business days"
fee_structure: "Actual cost of copying; $0.50/page maximum"
enforcement_body: "Freedom of Information Commission; Superior Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Connecticut.** Any person can submit a public records request to a public body in Connecticut. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Connecticut's rules before relying on this.*
...
> In accordance with the Connecticut Freedom of Information Act, Conn. Gen. Stat. §§ 1-200 to 1-242, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Connecticut law is 4 business days. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Connecticut's Connecticut Freedom of Information Act provides public access to government records held by state and local agencies.
...
Common exemptions under Connecticut law include:
...
- Actual cost of copying; $0.50/page maximum
...
1. You may file an appeal to Freedom of Information Commission — ask what the process is
...
Connecticut's Connecticut Freedom of Information Act (meetings) requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Connecticut's open meetings law can result in:
...
### Practical tips for Connecticut public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Freedom of Information Commission

### Key contacts

- **Connecticut Attorney General's Office** — may provide guidance on public records compliance
- **Connecticut Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Connecticut](https://www.rcfp.org/open-government-guide/connecticut/)
