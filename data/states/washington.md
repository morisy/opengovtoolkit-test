...
state: "Washington"
abbreviation: "WA"
foia_law: "Washington Public Records Act (PRA)"
foia_citation: "Wash. Rev. Code §§ 42.56.001–42.56.904"
open_meetings_law: "Washington Open Public Meetings Act"
open_meetings_citation: "Wash. Rev. Code §§ 42.30.010–42.30.920"
response_time: "5 business days (must respond; may provide installments)"
fee_structure: "Default charges set by statute; $0.15/page; no search or review fees"
enforcement_body: "Superior Court (penalties of $100/day for violations)"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Washington.** Any person can submit a public records request to a public body in Washington. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Washington's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 5 business days (must respond; may provide installments)
...
> In accordance with the Washington Public Records Act (PRA), Wash. Rev. Code §§ 42.56.001–42.56.904, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Washington law is 5 business days (must respond; may provide installments). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Washington's Washington Public Records Act (PRA) provides public access to government records held by state and local agencies.
...
Common exemptions under Washington law include:
...
- Default charges set by statute; $0.15/page; no search or review fees
...
2. You may file a lawsuit in Superior Court (penalties of $100/day for violations) (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
Washington's Washington Open Public Meetings Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Washington's open meetings law can result in:
...
### Practical tips for Washington public records requests
...
- **Washington Attorney General's Office** — may provide guidance on public records compliance
- **Washington Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Washington](https://www.rcfp.org/open-government-guide/washington/)
