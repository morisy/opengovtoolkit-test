...
state: "Oklahoma"
abbreviation: "OK"
foia_law: "Oklahoma Open Records Act"
foia_citation: "Okla. Stat. tit. 51, §§ 24A.1–24A.30"
open_meetings_law: "Oklahoma Open Meeting Act"
open_meetings_citation: "Okla. Stat. tit. 25, §§ 301–314"
response_time: "Prompt and reasonable (no specific statutory deadline)"
fee_structure: "Actual cost of copying; $0.25/page for standard copies"
enforcement_body: "District Court; District Attorney; Attorney General"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Oklahoma.** Any person can submit a public records request to a public body in Oklahoma. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Oklahoma's rules before relying on this.*
...
> In accordance with the Oklahoma Open Records Act, Okla. Stat. tit. 51, §§ 24A.1–24A.30, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Oklahoma law is a reasonable time. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Oklahoma's Oklahoma Open Records Act provides public access to government records held by state and local agencies.
...
Common exemptions under Oklahoma law include:
...
Under Oklahoma law:
- Actual cost of copying; $0.25/page for standard copies
...
Oklahoma's Oklahoma Open Meeting Act requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Oklahoma's open meetings law can result in:
...
### Practical tips for Oklahoma public records requests
...
- **Oklahoma Attorney General's Office** — may provide guidance on public records compliance
- **Oklahoma Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Oklahoma](https://www.rcfp.org/open-government-guide/oklahoma/)
