...
state: "Virginia"
abbreviation: "VA"
foia_law: "Virginia Freedom of Information Act (VFOIA)"
foia_citation: "Va. Code §§ 2.2-3700 to 2.2-3714"
open_meetings_law: "Virginia Freedom of Information Act (meetings)"
open_meetings_citation: "Va. Code §§ 2.2-3707 to 2.2-3712"
response_time: "5 business days (may invoke 7 more working days)"
fee_structure: "Actual cost of copying, search time, and computer time"
enforcement_body: "FOIA Council (advisory opinions); General District or Circuit Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Virginia.** Any person can submit a public records request to a public body in Virginia. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Virginia's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 5 business days (may invoke 7 more working days)
...
> In accordance with the Virginia Freedom of Information Act (VFOIA), Va. Code §§ 2.2-3700 to 2.2-3714, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Virginia law is 5 business days (may invoke 7 more working days). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Virginia's Virginia Freedom of Information Act (VFOIA) provides public access to government records held by state and local agencies.
...
Common exemptions under Virginia law include:
...
Under Virginia law:
- Actual cost of copying, search time, and computer time
...
1. You may file an appeal to FOIA Council (advisory opinions) — ask what the process is
2. You may file a lawsuit in General District or Circuit Court (the trial-court name varies by state — for example, Circuit Court, Superior Court, or District Court)
...
Virginia's Virginia Freedom of Information Act (meetings) requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Virginia's open meetings law can result in:
...
### Practical tips for Virginia public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to FOIA Council (advisory opinions)

### Key contacts

- **Virginia Attorney General's Office** — may provide guidance on public records compliance
- **Virginia Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Virginia](https://www.rcfp.org/open-government-guide/virginia/)
