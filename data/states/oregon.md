...
state: "Oregon"
abbreviation: "OR"
foia_law: "Oregon Public Records Law"
foia_citation: "Or. Rev. Stat. §§ 192.311–192.478"
open_meetings_law: "Oregon Public Meetings Law"
open_meetings_citation: "Or. Rev. Stat. §§ 192.610–192.690"
response_time: "5 business days (may extend with written notice)"
fee_structure: "Actual cost of providing a copy; may include search and review time"
enforcement_body: "Circuit Court; Attorney General; District Attorney"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Oregon.** Any person can submit a public records request to a public body in Oregon. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Oregon's rules before relying on this.*

**Key points:**
- Requests should be in writing (email is typically acceptable)
- Agencies must respond within 5 business days (may extend with written notice)
...
> In accordance with the Oregon Public Records Law, Or. Rev. Stat. §§ 192.311–192.478, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Oregon law is 5 business days (may extend with written notice). If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Oregon's Oregon Public Records Law provides public access to government records held by state and local agencies.
...
Common exemptions under Oregon law include:
...
Under Oregon law:
- Actual cost of providing a copy; may include search and review time
...
Oregon's Oregon Public Meetings Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Oregon's open meetings law can result in:
...
### Practical tips for Oregon public records requests
...
- **Oregon Attorney General's Office** — may provide guidance on public records compliance
- **Oregon Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Oregon](https://www.rcfp.org/open-government-guide/oregon/)
