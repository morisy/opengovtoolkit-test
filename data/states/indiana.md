...
state: "Indiana"
abbreviation: "IN"
foia_law: "Indiana Access to Public Records Act (APRA)"
foia_citation: "Ind. Code §§ 5-14-3-1 to 5-14-3-10"
open_meetings_law: "Indiana Open Door Law"
open_meetings_citation: "Ind. Code §§ 5-14-1.5-1 to 5-14-1.5-8"
response_time: "Reasonable time; must acknowledge within 7 calendar days"
fee_structure: "Actual cost of copying; $0.10/page for standard copies"
enforcement_body: "Public Access Counselor; Circuit Court"
last_updated: "2025-01-15"
---

## Getting data, documents, contracts and other records

**You have the right to request public records in Indiana.** Any person can submit a public records request to a public body in Indiana. You do not need to give a reason for your request.

*Some states limit who can request records to in-state residents or citizens — check Indiana's rules before relying on this.*
...
> In accordance with the Indiana Access to Public Records Act (APRA), Ind. Code §§ 5-14-3-1 to 5-14-3-10, I am requesting copies of the following records: [describe records]. I request a fee waiver or reduction, as disclosure of this information is in the public interest. Please respond within the time period required by law, which under Indiana law is a reasonable time. If any portion of this request is denied, please cite the specific exemption and release all records that are not exempt from disclosure in the same batch.

## Records Laws

Indiana's Indiana Access to Public Records Act (APRA) provides public access to government records held by state and local agencies.
...
Common exemptions under Indiana law include:
...
Under Indiana law:
- Actual cost of copying; $0.10/page for standard copies
...
1. You may file an appeal to Public Access Counselor — ask what the process is
...
Indiana's Indiana Open Door Law requires that government bodies conduct their business openly and that advance notice be given. *What counts as "advance" notice is defined differently from state to state.*
...
Violations of Indiana's open meetings law can result in:
...
### Practical tips for Indiana public records requests
...
5. **Know the appeals process** — if your request is denied, you have the right to appeal to Public Access Counselor

### Key contacts

- **Indiana Attorney General's Office** — may provide guidance on public records compliance
- **Indiana Press Association** — may offer FOI resources and support for journalists
- **Reporters Committee for Freedom of the Press** — free legal support and resources at rcfp.org

### Useful links

- [Reporters Committee FOI guide for Indiana](https://www.rcfp.org/open-government-guide/indiana/)
